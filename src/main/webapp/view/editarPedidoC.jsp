  ...
  <div class="col-md-12 text-center">
    <form  action="../controller/updPedidoC.jsp" method="POST" class="needs-validation" novalidate>
      <div class="row">
		...
		<input type="hidden" name="idPedido" value="<%out.println(idPedido);%>">	
      ...
      <div class="row">
        <div class="col-md-12 mb-3">
	        ...
	        <input type="email" class="form-control" id="email"  name="email" placeholder="tumail@gmail.com" value="<% out.println(pedido.getMail());%>"required>
	        <div class="invalid-feedback">
